...
@interface HYP3OrlandoObject : KrollCoverageObject {
#else
@interface HYP3OrlandoObject : KrollObject {
#endif
@private
...
extern NSString * HYP3Orlando$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HYP3OrlandoObject *_hyp3orlando;
    KrollObject* console;
	BOOL shutdown;
