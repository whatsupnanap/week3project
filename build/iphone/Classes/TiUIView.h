...
/**
 Base class for all HYP3Orlando views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HYP3Orlando view hierarchy (such as wrapped iOS UIViews) was touched.
